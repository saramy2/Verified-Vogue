...
const FailedQrModal = ({ open, setOpen }) => {
                        ...
                        >
                            ...
                            >
                                ...
                                <div className='md:px-[20px] pb-[20px] pt-[30px] '>
                                    ...
                                    <p className=' text-red-400 text-[14px] sm:text-[18px] font-medium pt-[20px]'>
                                        This item has not been authenticated by the brand on our
                                        platform.
                                    </p>
                                    <p className=' text-red-400 text-[14px] sm:text-[18px] font-medium pt-[10px]'>
                                        It may be counterfeit or outdated, predating the brand's
                                        adoption of our verification system.
                                    </p>
