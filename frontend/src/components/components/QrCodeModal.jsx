...
const QRCodeModal = ({ open, setOpen, data, setData, setopensold, setproductData, productData, setopenPrductModal }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`${BACKEND_URL}/api/product/detail/${data}`, {
                    method: 'GET',
                    headers: {
                            ...
                            >
                                ...
                                <div className='px-[10px] pb-[20px] pt-[30px] space-y-[15px]'>
                                    ...
                                    <div className="pt-[10px]">
                                        <button className="w-full text-white bg-sky-500 text-[18px] font-medium h-[40px] rounded-[10px] hover:bg-sky-600 duration-700 "
