...
const SoldProductModal = ({ open, setOpen , productId }) => {
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div className='md:px-[20px] pb-[20px] pt-[30px] '>
                                    <h2 className='text-center text-white font-semibold text-[20px] sm:text-[35px]'>
                                        Product ownership been changed 
                                    </h2>

                                    <div className='flex justify-center pt-[20px]'>
                                        <CheckCircleIcon className='h-[60px] sm:h-[80px] text-red-500' />
                                    </div>

                                    <p className='text-center text-gray-300 text-[14px] sm:text-[17px] font-normal pt-[20px]'>
                                        We wanted to inform you that the ownership of the product with ID {productId} has
                                        been successfully transferred. As a result, you no longer have access to the product
                                        information, and it has been removed from your database for security reasons.
                                        Please be aware that your old password will no longer grant access to the QR code
